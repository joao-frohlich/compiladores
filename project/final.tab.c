...
#line 112 "final.tab.c" /* yacc.c:339  */
...
#line 47 "final.y" /* yacc.c:355  */

	#include <vector>
	using namespace std;

#line 147 "final.tab.c" /* yacc.c:355  */
...
#line 186 "final.tab.c" /* yacc.c:355  */
};
...
#line 203 "final.tab.c" /* yacc.c:358  */
...
{
       0,    84,    84,    87,    88,    92,    93,    97,   107,   108,
     111,   112,   116,   133,   148,   149,   150,   151,   152,   167,
     168
};
#endif
...
{
  "$end", "error", "$undefined", "T_INT", "T_FLOAT", "IDENT", "OP_ARIT",
  "T_ATTR", "SEMICOLON", "TIPO_INT", "TIPO_FLOAT", "PRINT", "P_LEFT",
  "P_RIGHT", "B_LEFT", "B_RIGHT", "$accept", "programa", "blocoprincipal",
  "declaracoes", "declaracao", "listacmd", "comando", "cmdatrib",
  "cmdescrita", "expressaoaritmetica", "tipo", YY_NULLPTR
};
#endif
...
{
     -11,    15,    17,   -18,    11,   -18,   -18,    16,    15,   -18,
      -4,   -18,   -18,   -18,    25,   -18,     1,     1,   -18,    -3,
     -18,   -18,    14,   -18,   -18,   -18,     1,    21,     8,   -18,
     -18,    10,     1,   -18,    23,   -18,    26,   -18
};
...
{
       0,     0,     0,     2,     0,    19,    20,     0,     0,     6,
       0,     9,    10,    11,     0,     1,     0,     0,     5,     0,
       4,     8,     0,    14,    15,    18,     0,     0,     0,     3,
       7,     0,     0,    12,     0,    16,    17,    13
};
...
{
      28,     4,     4,     1,    23,    24,    25,     7,     7,    31,
      21,    20,    29,    26,    32,    36,    32,    15,    16,    21,
       4,    34,    30,    35,     5,     6,     7,    32,    17,    33,
      22,    37,    32,     0,     0,    18,    19
};

static const yytype_int8 yycheck[] =
{
      17,     5,     5,    14,     3,     4,     5,    11,    11,    26,
      10,    15,    15,    12,     6,    32,     6,     0,     7,    19,
       5,    13,     8,    13,     9,    10,    11,     6,    12,     8,
       5,     8,     6,    -1,    -1,     8,     8
};
...
{
       0,    14,    17,    18,     5,     9,    10,    11,    19,    20,
      21,    22,    23,    24,    26,     0,     7,    12,    20,    21,
      15,    22,     5,     3,     4,     5,    12,    25,    25,    15,
       8,    25,     6,     8,    13,    13,    25,     8
};
...
#line 1304 "final.tab.c" /* yacc.c:1646  */
    break;
...
#line 116 "final.y" /* yacc.c:1646  */
    {
		...
		if (checaId(str)){
			if (tabelaSimbolos[str].second == (yyvsp[-1].tipo_expressao).sType){
				if ((yyvsp[-1].tipo_expressao).sType == INT_T){
					escreveCodigo("istore "+to_string(tabelaSimbolos[str].first));
				} else if ((yyvsp[-1].tipo_expressao).sType == FLOAT_T){
...
#line 1324 "final.tab.c" /* yacc.c:1646  */
    break;

  case 13:
#line 133 "final.y" /* yacc.c:1646  */
    {
		if ((yyvsp[-2].tipo_expressao).sType == INT_T){
		...
		} else if ((yyvsp[-2].tipo_expressao).sType == FLOAT_T){
...
#line 1342 "final.tab.c" /* yacc.c:1646  */
    break;

  case 14:
#line 148 "final.y" /* yacc.c:1646  */
    {(yyval.tipo_expressao).sType = INT_T; escreveCodigo("ldc "+to_string((yyvsp[0].ival)));}
#line 1348 "final.tab.c" /* yacc.c:1646  */
    break;

  case 15:
#line 149 "final.y" /* yacc.c:1646  */
    {(yyval.tipo_expressao).sType = FLOAT_T; escreveCodigo("ldc "+to_string((yyvsp[0].fval)));}
#line 1354 "final.tab.c" /* yacc.c:1646  */
    break;

  case 16:
#line 150 "final.y" /* yacc.c:1646  */
    {(yyval.tipo_expressao).sType = (yyvsp[-1].tipo_expressao).sType;}
#line 1360 "final.tab.c" /* yacc.c:1646  */
    break;

  case 17:
#line 151 "final.y" /* yacc.c:1646  */
    {traduzOpArit((yyvsp[-2].tipo_expressao).sType, (yyvsp[0].tipo_expressao).sType, (yyvsp[-1].opval));}
#line 1366 "final.tab.c" /* yacc.c:1646  */
    break;
...
#line 152 "final.y" /* yacc.c:1646  */
    {
		...
		if (checaId(str)){
			(yyval.tipo_expressao).sType = tabelaSimbolos[str].second;
			if ((yyval.tipo_expressao).sType == INT_T)
				escreveCodigo("iload "+to_string(tabelaSimbolos[str].first));
			if ((yyval.tipo_expressao).sType == FLOAT_T)
...
#line 1384 "final.tab.c" /* yacc.c:1646  */
    break;

  case 19:
#line 167 "final.y" /* yacc.c:1646  */
    {(yyval.sType) = INT_T;}
#line 1390 "final.tab.c" /* yacc.c:1646  */
    break;

  case 20:
#line 168 "final.y" /* yacc.c:1646  */
    {(yyval.sType) = FLOAT_T;}
#line 1396 "final.tab.c" /* yacc.c:1646  */
    break;
